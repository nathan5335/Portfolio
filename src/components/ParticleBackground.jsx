...
const ParticleBackground = () => {
  ...
  useEffect(() => {
    ...
    if (canvas.width < 768) {
      ...
      particleCount = Math.min(30, Math.max(15, Math.floor(canvas.width / 40)));
    } else if (canvas.width < 1024) {
      // Tablet: medium particles
      particleCount = Math.min(60, Math.max(40, Math.floor(canvas.width / 25)));
    } else {
      // Desktop: more particles
      particleCount = Math.min(100, Math.max(50, Math.floor(canvas.width / 20)));
    }
    ...
    const drawConnections = () => {
      // Skip connections on mobile devices for better performance
